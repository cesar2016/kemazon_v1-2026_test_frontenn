        ...
        {images.map((_, index) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
              currentIndex === index ? 'bg-primary-500 w-8' : 'bg-white/30 hover:bg-white/50'
            }`}
          />
        ))}
      </div>
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-4 w-full">
                ...
                >
                  ...
                  <button
                    ...
                    className={`absolute top-6 right-6 z-10 p-4 rounded-3xl transition-all duration-300 shadow-xl backdrop-blur-md ${
                      product.is_liked
