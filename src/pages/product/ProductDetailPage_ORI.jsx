    ...
    <Layout>
      <div className="bg-white py-4 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center flex-wrap gap-y-2 space-x-2 text-[10px] sm:text-sm text-gray-500 mb-4 sm:mb-6">
            <Link to="/" className="hover:text-primary-600 flex-shrink-0">Inicio</Link>
            <span className="flex-shrink-0">/</span>
            <Link to="/products" className="hover:text-primary-600 flex-shrink-0">Productos</Link>
            <span className="flex-shrink-0">/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-row gap-3 sm:gap-4">
                {/* Thumbnails Column - Vertical on the left */}
                <div className="flex flex-col gap-2 overflow-y-auto scrollbar-hide max-h-[300px] sm:max-h-[500px] w-14 sm:w-20 lg:w-24 flex-shrink-0">
                  {images.map((image, index) => (
                    <button
                      ...
                      className={`aspect-square rounded-xl overflow-hidden border-2 transition-all flex-shrink-0 ${selectedImage === index ? 'border-primary-500 ring-2 ring-primary-200 shadow-sm' : 'border-gray-200 hover:border-gray-300'
                        }`}
                    >
                ...
                <div
                  className="flex-1 min-w-0 relative rounded-2xl overflow-hidden bg-gray-50 cursor-zoom-in group h-[300px] sm:h-[400px] lg:h-[500px] border border-gray-100 shadow-sm"
                ...
                >
                  ...
                  {product.type === 'auction' && (
                    <Badge variant="warning" className="absolute top-3 left-3 sm:top-4 sm:left-4">
                      <Gavel className="w-4 h-4 mr-1" /> Subasta
                    </Badge>
                  )}

                  {images.length > 1 && (
                    <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-black/60 backdrop-blur-md text-white text-[10px] sm:text-xs px-2.5 py-1 rounded-full z-10 font-bold">
              ...
              <div className="bg-white border border-gray-100 rounded-3xl p-5 sm:p-8 shadow-sm">
                ...
                <div className="prose prose-sm max-w-none text-gray-600 leading-relaxed">
                  <p className="whitespace-pre-wrap">{product.description || 'Sin descripción disponible'}</p>
                </div>
              </div>
            </div>
            ...
            {/* Right Column: Buy Info Section */}
            <div className="space-y-6 min-w-0">
              <div>
                <div className="flex items-start justify-between mb-3 gap-4">
                  <div className="min-w-0 flex-1">
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-0 break-words line-clamp-2">{product.name}</h1>
                  </div>
              ...
              {product.type === 'direct' ? (
                <div className="border-b pb-4">
                  <PriceFormatter price={product.price} className="text-2xl sm:text-3xl font-bold" />
                  ...
                  <div className="text-center mb-4">
                    ...
                    {auction && auction.current_price > auction.starting_price && (
                      <div className="mt-3">
                        ...
                        <PriceFormatter price={auction.current_price} className="text-2xl sm:text-4xl font-bold text-green-600" />
                      </div>
                    )}
                  </div>
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      <div className="flex items-center gap-2">
                                        <p className={`text-sm font-medium truncate max-w-[100px] sm:max-w-[150px] ${isWinner ? 'text-amber-700' : 'text-gray-800'}`}>
              ...
              <div className="bg-gray-50 rounded-2xl p-4 sm:p-5">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="font-bold text-sm text-gray-900">Formas de pago</span>
                </div>
                <div className="flex flex-wrap gap-x-6 gap-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs font-medium text-gray-600">
                    <span className="text-primary-600 font-bold">mercadopago</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs font-medium text-gray-600">
                    <span>Efectivo</span>
                  </div>
