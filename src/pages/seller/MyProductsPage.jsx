...
import { Button, Card, Badge, PriceFormatter, Spinner, Modal, CountdownTimer } from '../../components/ui';
    ...
    <>
      <tr className="border-b border-gray-100 hover:bg-gray-50">
        <td className="py-4 px-4">
          {mainImage ? (
            <img src={mainImage} alt={product.name} className="w-14 h-14 object-cover rounded-lg" />
          ) : (
